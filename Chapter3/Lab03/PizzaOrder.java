...
public class PizzaOrder
{
   public static void main (String[] args)
   {
	  ...
	  if(firstName.compareToIgnoreCase("Mike") == 0 ||
		firstName.compareToIgnoreCase("Diane") == 0) discount = true;
	  ...
	  {
		  System.out.println(inches + " is not a valid size. You will receive a 12\" pizza");
			inches = 12;
			cost = 12.99;
	  } 
	  ...
	  switch(crustType)
	  {
		  ...
		  case 'd':
			...
			break;
		  default:
			System.out.println(crustType + " is not a choice. You will get Hand-tossed");
			crust = "Hand-tossed";
	  }
